...
const Testimonials = () => {
  const testimonials = [
    {
      id: 1, 
      content: "GreenGuide has completely transformed the way I connect with nature. The platform's commitment to environmental awareness and sustainable practices is truly inspiring. It is a hub for like-minded individuals passionate about preserving our forests and creating a greener future.", 
    ...
    {
      id: 2, 
      content: "Being a part of GreenGuide has been an incredible journey. The platform not only fosters a sense of community but also educates and empowers users to make a positive impact on our environment. I'm proud to be associated with such a meaningful initiative.", 
    ...
    { 
      id: 3, 
      content: "GreenGuide is more than just a platform; it's a movement. I've discovered new ways to contribute to environmental conservation, and the community support is unparalleled. Together, we can make a lasting difference for our planet.", 
    ...
    { 
      id: 4, 
      content: "As a nature enthusiast, GreenGuide has become my go-to place for connecting with fellow nature lovers and staying informed about conservation efforts. The platform's user-friendly interface and wealth of resources make it a valuable tool for anyone passionate about preserving our forests.", 
